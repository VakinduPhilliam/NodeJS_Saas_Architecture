...
// object to return for error handling in controller
...
var where = _getDatesQuery(query); 

// get where query object
...
if (newPromoterData.id) delete newPromoterData.id; 

// Remove ID to avoid modifying it
...
// indexOf because message is sent as a string
...
// got to catch this way because validations are not async =(
...
if (newData.UserId) delete newData.UserId; 

// Remove UserId to avoid modifying it
